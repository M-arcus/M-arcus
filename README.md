...
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.6.15](https://github.com/shopware/shopware-cli/releases/tag/0.6.15), today) - CLI for Shopware Account and Shopware 6
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.7.0.1](https://github.com/shopware/shopware/releases/tag/v6.7.0.1), today) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 3.100 community extensions
