...
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.6.0](https://github.com/shopware/shopware-cli/releases/tag/0.6.0), 2 days ago) - CLI for Shopware Account and Shopware 6
...
- [deployphp/deployer](https://github.com/deployphp/deployer) ([v8.0.0-alpha.2](https://github.com/deployphp/deployer/releases/tag/v8.0.0-alpha.2), 3 days ago) - The PHP deployment tool with support for popular frameworks out of the box
- [shopware/deployment-helper](https://github.com/shopware/deployment-helper) ([0.0.22](https://github.com/shopware/deployment-helper/releases/tag/0.0.22), 3 days ago) - Simplify Shopware Deployments
- [shopwareLabs/extension-verifier](https://github.com/shopwareLabs/extension-verifier) ([0.1.10](https://github.com/shopwareLabs/extension-verifier/releases/tag/0.1.10), 4 days ago) - 
