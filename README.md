...
- [FriendsOfShopware/shopmon](https://github.com/FriendsOfShopware/shopmon) ([1.0.2](https://github.com/FriendsOfShopware/shopmon/releases/tag/1.0.2), 1 day ago) - Shopware Shop Monitoring
...
- [FriendsOfShopware/FroshPlatformHtmlMinify](https://github.com/FriendsOfShopware/FroshPlatformHtmlMinify) ([2.4.0](https://github.com/FriendsOfShopware/FroshPlatformHtmlMinify/releases/tag/2.4.0), 2 days ago) - This plugin allows you to minify your HTML output.
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.15.10](https://github.com/shopware/shopware-cli/releases/tag/0.15.10), 2 days ago) - CLI for Shopware Account and Shopware 6
- [shopware/deployment-helper](https://github.com/shopware/deployment-helper) ([0.1.1](https://github.com/shopware/deployment-helper/releases/tag/0.1.1), 5 days ago) - Simplify Shopware Deployments
...
- [refactor: move product slider random sort to PHP shuffle](https://github.com/shopware/shopware/pull/17689) on [shopware/shopware](https://github.com/shopware/shopware) (1 day ago)
