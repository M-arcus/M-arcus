...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.0.0-rc.13](https://github.com/carthage-software/mago/releases/tag/1.0.0-rc.13), 1 day ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
...
- [Harden security](https://github.com/FriendsOfCXML/cxml-php/pull/47) on [FriendsOfCXML/cxml-php](https://github.com/FriendsOfCXML/cxml-php) (5 days ago)
- [Replace removed rule PropertyFetchToMethodCallRector](https://github.com/FriendsOfShopware/shopware-rector/pull/59) on [FriendsOfShopware/shopware-rector](https://github.com/FriendsOfShopware/shopware-rector) (6 days ago)
