...
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.10.6](https://github.com/shopware/shopware/releases/tag/v6.6.10.6), 1 day ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 3.100 community extensions
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.6.23](https://github.com/shopware/shopware-cli/releases/tag/0.6.23), 2 days ago) - CLI for Shopware Account and Shopware 6
...
- [fix: don&#39;t check for canonical seo urls when no path info given during seo url creation](https://github.com/shopware/shopware/pull/11443) on [shopware/shopware](https://github.com/shopware/shopware) (today)
