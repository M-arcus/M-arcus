...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.0.2](https://github.com/carthage-software/mago/releases/tag/1.0.2), 1 day ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([3.2.4](https://github.com/FriendsOfShopware/FroshTools/releases/tag/3.2.4), 3 days ago) - A collection of useful tools for Shopware 6
