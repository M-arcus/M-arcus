...
- [mollie/Shopware6](https://github.com/mollie/Shopware6) ([v4.12.0](https://github.com/mollie/Shopware6/releases/tag/v4.12.0), today) - 
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.8.2](https://github.com/shopware/shopware/releases/tag/v6.6.8.2), today) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
- [shopware/deployment-helper](https://github.com/shopware/deployment-helper) ([0.0.12](https://github.com/shopware/deployment-helper/releases/tag/0.0.12), today) - Simplify Shopware Deployments
