...
- [FriendsOfCXML/cxml-php](https://github.com/FriendsOfCXML/cxml-php) ([2.2.2](https://github.com/FriendsOfCXML/cxml-php/releases/tag/2.2.2), today) - PHP Implementation of cXML Standard
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.7.9.1](https://github.com/shopware/shopware/releases/tag/v6.7.9.1), today) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 3.100 community extensions
- [deployphp/deployer](https://github.com/deployphp/deployer) ([v8.0.0](https://github.com/deployphp/deployer/releases/tag/v8.0.0), 1 day ago) - The PHP deployment tool with support for popular frameworks out of the box
...
- [Add cache functionality](https://github.com/php-parallel-lint/PHP-Parallel-Lint/pull/203) on [php-parallel-lint/PHP-Parallel-Lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) (4 days ago)
