...
- [FriendsOfCXML/cxml-php](https://github.com/FriendsOfCXML/cxml-php) ([2.2.2](https://github.com/FriendsOfCXML/cxml-php/releases/tag/2.2.2), 1 day ago) - PHP Implementation of cXML Standard
...
- [deployphp/deployer](https://github.com/deployphp/deployer) ([v8.0.0](https://github.com/deployphp/deployer/releases/tag/v8.0.0), 2 days ago) - The PHP deployment tool with support for popular frameworks out of the box
...
- [Add cache functionality](https://github.com/php-parallel-lint/PHP-Parallel-Lint/pull/203) on [php-parallel-lint/PHP-Parallel-Lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) (5 days ago)
