...
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.6.27](https://github.com/shopware/shopware-cli/releases/tag/0.6.27), today) - CLI for Shopware Account and Shopware 6
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.0.0-alpha.9](https://github.com/carthage-software/mago/releases/tag/1.0.0-alpha.9), today) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
...
- [Improve handling of one time tasks table-creation and task marking](https://github.com/shopware/deployment-helper/pull/59) on [shopware/deployment-helper](https://github.com/shopware/deployment-helper) (today)
