...
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.7.1.0](https://github.com/shopware/shopware/releases/tag/v6.7.1.0), 4 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 3.100 community extensions
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.6.23](https://github.com/shopware/shopware-cli/releases/tag/0.6.23), 1 week ago) - CLI for Shopware Account and Shopware 6
...
- [FriendsOfShopware/FroshLazySizes](https://github.com/FriendsOfShopware/FroshLazySizes) ([3.2.0](https://github.com/FriendsOfShopware/FroshLazySizes/releases/tag/3.2.0), 2 weeks ago) - This plugin allows you to use lazy loading for your images.
...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([0.26.1](https://github.com/carthage-software/mago/releases/tag/0.26.1), 4 weeks ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
...
- [fix: don&#39;t check for canonical seo urls when no path info given during seo url creation](https://github.com/shopware/shopware/pull/11443) on [shopware/shopware](https://github.com/shopware/shopware) (5 days ago)
