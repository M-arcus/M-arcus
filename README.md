...
- [ddev/ddev-adminer](https://github.com/ddev/ddev-adminer) - AdminerEvo service for DDEV (4 days ago)
...
- [deployphp/deployer](https://github.com/deployphp/deployer) ([v7.5.6](https://github.com/deployphp/deployer/releases/tag/v7.5.6), today) - The PHP deployment tool with support for popular frameworks out of the box
- [ddev/ddev-adminer](https://github.com/ddev/ddev-adminer) ([v1.0.0](https://github.com/ddev/ddev-adminer/releases/tag/v1.0.0), 4 days ago) - AdminerEvo service for DDEV
...
- [Use adminerevo docker image instead of the deprecated adminer image, fixes #27](https://github.com/ddev/ddev-adminer/pull/30) on [ddev/ddev-adminer](https://github.com/ddev/ddev-adminer) (5 days ago)
