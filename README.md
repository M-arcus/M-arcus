...
- [shopware/deployment-helper](https://github.com/shopware/deployment-helper) ([0.1.3](https://github.com/shopware/deployment-helper/releases/tag/0.1.3), today) - Simplify Shopware Deployments
...
- [shopware/shopware-cli](https://github.com/shopware/shopware-cli) ([0.18.1](https://github.com/shopware/shopware-cli/releases/tag/0.18.1), 1 day ago) - CLI for Shopware Account and Shopware 6
- [FriendsOfShopware/shopmon](https://github.com/FriendsOfShopware/shopmon) ([1.0.15](https://github.com/FriendsOfShopware/shopmon/releases/tag/1.0.15), 2 days ago) - Shopware Shop Monitoring
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([3.13.0](https://github.com/FriendsOfShopware/FroshTools/releases/tag/3.13.0), 2 days ago) - A collection of useful tools for Shopware 6
...
- [feat: add config for checksum during project build](https://github.com/shopware/shopware-cli/pull/1293) on [shopware/shopware-cli](https://github.com/shopware/shopware-cli) (3 weeks ago)
